...
set "tests=binary\xdr binary\boost binary\cdr xpath multiroot mixed custom\mixed custom\wildcard custom\calendar custom\double custom\taxonomy custom\contacts custom\comments caching wildcard compression streaming messaging embedded library polymorphism order\element order\mixed hello performance"
